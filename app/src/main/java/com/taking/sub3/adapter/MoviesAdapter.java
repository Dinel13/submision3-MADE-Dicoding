...
import com.taking.sub3.activity.MoviesDetailActivity;
import com.taking.sub3.model.Movies;
...
public class MoviesAdapter extends RecyclerView.Adapter<MoviesAdapter.MovieViewHolder> {
    ...
    class MovieViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        TextView textViewTitle,
                textViewVoteAverage, textViewVoteCount, textViewDetailOverview;
        ...
        MovieViewHolder(@NonNull View itemView) {
            ...
            textViewDetailOverview = itemView.findViewById(R.id.tv_item_overview);
...
//            textViewDateReleased.setText(movies.getRelease_date());
            textViewDetailOverview.setText(movies.getOverview());
